                    ...
                    <div class="product-area clearfix">
                        ...
                        <div class="grid">
                            <div class="product-pic">
                                <img src="{{ asset('uploads/product_photo') }}/{{ $product->thumbnail }}" alt>
                                @if ($product->discount_price)
                                <span class="theme-badge-2">{{ round(100-($product->discount_price*100)/$product->regular_price) }}
                                    % off
                                </span>
                                @else
                            ...
                            <div class="details">
                                ...
                                <p><a href="{{ route('productDetails',$product->id) }}">{{ Str::limit($product->description, 45) }}
                                </a></p>
                                <div class="rating">
                                ...
                                <div class="add-cart-area">
                                    <a href="{{ route('productDetails',$product->id) }}" class="add-to-cart btn btn-success">Details</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                            ...
                            <div class="category_boxed">
                                <a href="#!">
                                        <span class="item_image">
                                            <img src="{{ asset('uploads/category_photo') }}/{{ $category->category_photo }}" alt="image_not_found">
                                        </span>
                        ...
                        <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                            ...
                            <div class="slider_item">
                                <div class="small_product_layout">
                                    ...
                                    <div class="item_content">
                                        <h3 class="item_title">
                                            <a href="shop_details.html">{{ $product->name }}</a>
                                        </h3>
